  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-7xl">
      ...
      <div className="mb-12">
        ...
        <p className="text-xl text-primary mb-6">Junior Front-end Developer</p>
          ...
          <section>
            ...
            <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
              <p className="text-gray-300 leading-relaxed">
                ...
                design, as well as the development of scalable web applications.
                Skilled in HTML, CSS, JavaScript, React, Next.js, and Tailwind
                CSS for creating modern websites. Solid project management
                skills can assist in the timely delivery of projects.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                <div className="flex flex-wrap items-start justify-between mb-3">
                  <h3 className="text-xl font-bold text-primary">WristLook</h3>
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-300">
                    Google Antigravity, NextJs, NextAuth, ReactJS, Tailwindcss,
                    DaysiUI, ExpressJs, MongoDB.
                  </p>
                </div>
              </div>
              ...
              <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                ...
                <div className="mb-3">
                  ...
                  <p className="text-sm text-gray-300">
                    ...
                    (Update & Delete), Theme toggling, user login & registration
                    and Order list PDF download.
                  </p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-gray-400 mb-1">
              ...
              <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                ...
                <p className="text-gray-300 mb-3">
                  A responsive Single Page Application (SPA) designed for plant
                  enthusiasts to explore indoor collections, access care guides,
                  and book expert consultations.
                </p>
                <div className="mb-3">
                  <p className="text-sm font-semibold text-gray-400 mb-1">
                    Features:
          ...
          <section>
            ...
            <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
              ...
              <p className="text-gray-300 text-sm">
                Organized 10+ community events for underprivileged childrens in
                jamalpur district, each one had a minimum of 100 participants.
                Worked with district police and Department of Narcotics Control
                (DNC) for batter jamalpur.
              </p>
            </div>
          </section>
        </div>
