...
const About = () => {
  return (
    <>
      <MetaData
        title="Atik Hasan | About"
        description="A collection of my recent projects showcasing my skills in web development, design, and problem-solving."
        keywords="Atik Hasan, Portfolio, Works, Projects, Web Development, Design, Problem Solving"
        author="Atik Hasan"
      />
      <PageTransition>
              ...
              <section>
                ...
                <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                  <p className="text-gray-300 leading-relaxed">
                    Highly motivated and energetic, I possess a strong passion
                    for contemporary and visually striking frontend design,
                    secure backend development, and building scalable web
                    applications. My experience includes the successful
                    completion of four attractive projects, complemented by
                    solid project management skills to ensure timely delivery.
                  </p>
                </div>
              </section>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                    ...
                    <p className="text-gray-300 mb-3">
                      ...
                      tracking—replacing chaotic manual processes with a
                  ...
                  <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                    ...
                    <p className="text-gray-300 mb-3">
                      A watch collection platform where buyers and sellers can
                      buy their desired watch for a very reasonable cost. This
                      site is built with the latest NEXTJS and other modern
                      technology.
                    </p>
                    <div className="mb-3">
                      <p className="text-sm font-semibold text-gray-400 mb-1">
                  ...
                  <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                    ...
                    <p className="text-gray-300 mb-3">
                      A community-driven platform for pet adoption and pet
                      product sales. Connects pet owners, breeders, and shops in
                      a centralized hub.
                    </p>
                    <div className="mb-3">
                      <p className="text-sm font-semibold text-gray-400 mb-1">
                      ...
                      <p className="text-sm text-gray-300">
                        Category-wise search & sort, Add products, Manage
                        products (Update & Delete), Theme toggling, user login &
                  ...
                  <div className="border border-gray-700 p-6 rounded-lg bg-gray-900/30">
                    ...
                    <p className="text-gray-300 mb-3">
                      ...
                      plant enthusiasts to explore indoor collections, access
                      care guides, and book expert consultations.
                    </p>
                    <div className="mb-3">
                      <p className="text-sm font-semibold text-gray-400 mb-1">
                        Features:
                      ...
                      <p className="text-sm text-gray-300">
                        ...
                        Protected Private Routes (Details & Profile), Dynamic
                        Data Fetching from JSON, Real-time Profile Management,
                        Book consultant toast.
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-gray-400 mb-1">
